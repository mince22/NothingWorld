...
void BinaryWriter::Vector2(const vec2& data)
{
	WriteFile(fileHandle, &data, sizeof(vec2), &size, NULL);
}

void BinaryWriter::Vector3(const vec3& data)
{
	WriteFile(fileHandle, &data, sizeof(vec3), &size, NULL);
}

void BinaryWriter::Vector4(const vec4& data)
{
...
void BinaryWriter::Matrix(const mat4x4& data)
{
	WriteFile(fileHandle, &data, sizeof(mat4x4), &size, NULL);
}
